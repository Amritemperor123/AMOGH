...
const SignUp = () => {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="w-1/2 bg-gradient-to-br from-purple-400 to-slate-400 flex flex-col p-8 relative overflow-hidden">
        {/* Header */}
        <div className="text-center mb-8 animate-fade-in">
          <div className="bg-white rounded-xl px-6 items-center justify-around shadow-md w-fit mx-auto">
        ...
        {/* User Type Selection */}
        {currentStep === 1 && (
          <div className="animate-scale-in delay-400 mb-8">
              ...
              {userTypes.map((type) => {
                ...
                return (
                  <button
                    ...
                    className={`p-4 rounded-xl border-2 transition-all duration-500 text-center ${formData.userType === type.id
                        ? "border-blue-500 bg-blue-50 scale-105 shadow-lg"
                        : "bg-white/70 hover:scale-102 hover:shadow-md"
                      }`}
                  >
                    <div className={`w-8 h-8 ${type.color} rounded-xl mb-2 flex items-center justify-center shadow-md mx-auto`}>
