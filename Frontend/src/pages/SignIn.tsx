...
const SignIn = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-400 to-purple-400 flex items-center justify-center p-4 relative overflow-hidden">
      <div className="w-full max-w-7xl relative z-10 grid lg:grid-cols-2 gap-8">
                  ...
                  {userTypes.map((type) => {
                    ...
                    return (
                      <button
                        ...
                        className={`p-5 rounded-xl border-2 transition-all duration-500 text-left bg-white shadow-sm ${
        ...
        {/* Right side - Header, Progress, User Type Cards, and Benefits */}
        <div className="space-y-8">
          {/* Header wrapped in white rectangle */}
          <div className="bg-white rounded-xl p-6 shadow-lg animate-fade-in">
            <div className="w-30 flex items-left space-x-2 mb-6">
              ...
              {[1, 2, 3].map((step) => (
                <div key={step} className="flex items-center">
                  <div className={`w-10 h-10 rounded-full flex items-center justify-center font-medium transition-all duration-500 ${
                    ...
                    {step < currentStep ? <Check className="bg-white w-5 h-5" /> : step}
                  </div>
                  {step < 3 && (
          ...
          <div className="animate-scale-in delay-300">
            <h3 className="text-lg font-semibold text-gray-900 mb-4 text-center">Choose Your Path</h3>
              ...
              {userTypes.map((type) => {
                ...
                return (
                  <button
                    key={type.id}
                    onClick={() => handleInputChange('userType', type.id)}
                    className={`p-4 rounded-xl border-2 transition-all duration-500 text-center bg-white shadow-sm ${
                      formData.userType === type.id
                        ? "border-blue-500 scale-105 shadow-lg"
                        : "border-gray-200 hover:border-gray-300 hover:scale-102 hover:shadow-md"
                    }`}
          ...
          {/* Benefits Card */}
          {currentUserType && (
            <Card className={`backdrop-blur-lg bg-gradient-to-br ${currentUserType.gradient} border-0 shadow-xl transition-all duration-500 hover:shadow-2xl hover:scale-105 animate-scale-in delay-400`}>
