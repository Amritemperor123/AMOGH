...
import { User, MapPin, Calendar, Award, TrendingUp, BookOpen, Target, Camera, Instagram, Twitter, Linkedin, Youtube, Facebook, Mail, Globe, Star } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row items-end gap-6">
            ...
            <div className="relative">
              <img src={profile.avatar} alt={profile.name} className="w-32 h-32 rounded-full border-4 border-white shadow-lg object-cover justify-center flex items-center " />
    ...
    <div className="max-w-7xl mx-auto px-8 -mt-8 relative z-10">
      <Card className="p-4 shadow-lg border-0 backdrop-blur-sm transition-all duration-300 hover:shadow-xl bg-blue-50">
        <div className="grid grid-cols-4 gap-4">
          ...
          <div className="text-center group cursor-pointer">
            <div className="text-2xl font-bold text-slate-800 mb-1 group-hover:text-blue-600 transition-colors">{profile.stats.likes}</div>
